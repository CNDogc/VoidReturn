...
> 版本 / Version 2.0.3 · Paper 26.2（Java 25）· 轻量来源记忆型虚空传送插件
...
1. 将 `VoidReturn-2.0.3.jar` 放入服务器 `plugins/` 目录。Put the jar into the server's `plugins/` folder.
...
- 构建 / Build：`.\gradlew.bat build`，产物 / artifact：`build/libs/VoidReturn-2.0.3.jar`
